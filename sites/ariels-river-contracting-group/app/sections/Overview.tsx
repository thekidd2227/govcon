...
export function Overview() {
  return (
    <section className="border-t border-[var(--arcg-line)]">
      <div className="mx-auto max-w-[var(--container-content)] px-6 lg:px-10 py-20 lg:py-28">
        ...
        <div className="mt-6 grid gap-10 lg:grid-cols-12">
          ...
          <div className="lg:col-span-6 lg:pl-6 lg:border-l lg:border-[var(--arcg-line)]">
            <div className="hairline-gold mb-6 lg:hidden" />
            <p className="text-[18px] leading-[1.6] text-arcg-graphite max-w-[560px]">
